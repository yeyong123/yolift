    ...
    $("#imageMenu li img").bind("click", function(){
		if ($(this).attr("id") != "onlickImg") {
			midChange($(this).attr("src").replace("/assets/small", "/assets/mid"));
		...
		if($(this).attr("id") != "onlickImg"){
			...
			midChangeHandler = window.setTimeout(function(){
				midChange($("#onlickImg img").attr("src").replace("/assets/small", "/assets/mid"));
			}, 1000);
		}
	});
    ...
    function changeViewImg() {
        $("#bigView img").attr("src", $("#midimg").attr("src").replace("/assets/mid", "/assets/big"));
    }
