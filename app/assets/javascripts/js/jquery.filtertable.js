...
(function($) {
	...
	$.fn.filterTable = function(options) { // define the filterTable plugin
		var defaults = { // start off with some default settings
				...
				label:             '检索:',           // text to precede the filter input tag
				minRows:           2,                   // don't show the filter on tables with less than this number of rows
				placeholder:       '输入关键字或编号', // HTML5 placeholder text for the filter field
