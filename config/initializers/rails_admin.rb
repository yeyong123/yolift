# RailsAdmin config file. Generated on December 25, 2013 09:18
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Yolift', 'Admin']
  ...
  # config.model 'Bananer' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your bananer.rb model definition
  ...
  #     configure :descript, :string 
  #     configure :button, :string 
  ...
  #     configure :province, :has_one_association 
  ...
  #     configure :productnumbers, :has_many_association 
  ...
  #     configure :productnumbers, :has_many_association 
  #     configure :productcolors, :has_many_association 
  #     configure :line_items, :has_many_association 
  ...
  #     configure :printpdf, :carrierwave 
  #     configure :video, :carrierwave 
  #     configure :color, :string 
  #     configure :listtext, :text 
  #     configure :techparams, :text 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your productcolor.rb model definition
  ...
  # config.model 'Productnumber' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your productnumber.rb model definition
  ...
  #     configure :cart, :has_one_association 
